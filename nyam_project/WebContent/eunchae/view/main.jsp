	...
	<section class="rightCon post-slider">
		<div class="main_title">
			<div class="mainSearch">
				<form method="post"
					action="<%=request.getContextPath()%>/review_searchs.do">
			...
			<div class="mainReviewCon slide_div post-wrapper">
				...
				<c:if test="${!empty list}">
					...
					<c:forEach items="${list }" var="dto">
						...
						<div class="post">
							<a
								href="<%=request.getContextPath()%>/review_content.do?no=${dto.getReview_num()}">
								<img
...
<c:if test="${!empty dto2.getReview_image() }">
						...
						<div class="post">
							<a
								href="<%=request.getContextPath()%>/review_content.do?no=${dto2.getReview_num()}">
								<img
